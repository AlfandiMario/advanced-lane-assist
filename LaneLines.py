...
class LaneLines:
    ...
    def extract_features(self, img):
        ...
        self.window_height = np.int_(img.shape[0]//self.nwindows)
    ...
    def plot(self, out_img):
        ...
        cv2.putText(out_img, msg, org=(10, 240), fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=1.1, color=(255, 255, 255), thickness=2)
        # Tulisan Curvature
        # if direction in 'LR':
        ...
        cv2.putText(
            out_img,
            "Mobil {:.2f} m dari tengah".format(pos),
            org=(10, 330),
            fontFace=cv2.FONT_HERSHEY_SIMPLEX,
            fontScale=0.66,
            color=(255, 255, 255),
